...
function emailsignup(){
    ...
    {
        document.getElementById("errorifany").innerHTML = "";
        signupurl = "http://127.0.0.1:8000/ss?id="+memberid+"&email="+useremail+"&special_id="+special_id;
        $.ajax({
            type: "GET",
            dataType: 'json',
            crossDomain: true,
            ...
            document.getElementById("fooddiv").innerHTML = `
                ...
                <div class="chat-popup" id="myForm" style="z-index: 25;overflow:hidden;">
                    ...
                    <form action="javascript:void(0);" class="form-container">
                        ...
                        <hr>
                        <p style="color:#fff;font-weight:100;"><center><strong>Ends:</strong> ${expires}</center></p>
